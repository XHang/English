...
所谓辅音组合，就是辅音之间的直接组合，没有元音

发音规律：读音大多是分开的，但是首位发音较弱，次辅音发音较长且重，而且该组合后面大多是接元音字母
...
1. A+R发音类似为[a:]，如car，party,Art,
2. E、I、O、U+R发音类似`/ɜ/`,如bird ，skirt ，doctor （`/ə/`）
3. `ou`组合发音类似于`[aʊ]`，如out
4. `oy`组合发音类型与`[ɔɪ]`,如boy、annoy
...
| spell    | phonetic syymbol | chinese |
| -------- | ---------------- | ------- |
| zero     | /'zɪərəʊ/        | 零      |
| news     | /njuːz/          | 新闻    |
| zoo      | /zuː/            | 动物园  |
...
The chicken is nery cheap 鸡肉很便宜
...
从此音标开始，下面的音标都叫做半元音，滑音，半辅音，该音一经发出，会快速的向元音滑动
...
当两个辅音相连的时候，前面的辅音受后面的辅音的影响，在发音时只需要做口型，而不需要把音发出来
