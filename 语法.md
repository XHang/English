...
> 单词不等于名词，在英语里，一个单词可能对应多个名词，所以这里的名词 
...
2. 集体名词 
   ...
   | collectIve noun | translate                                                    | example                            | 
   | --------------- | ------------------------------------------------------------ | ---------------------------------- | 
   | 人们，人民      | people<br />特别注意的是，people还可以表达为民族，有单复数的变化<br />例如： The Chinese are an industrious people<br />the English-speakung peoples<br />而表达为民族这个意思时，谓语也经常用复数形式<br />The Chinese people have achieved a great success | There were many people in the room | 
   | 牛群            | cattle                                                       |                                    | 
   | 警察            | police                                                       |                                    | 
   | 家禽            | poultry<br />该单词还可以                                    |                                    | 
...
A loaf of something （一条某物）           
 
> a loaf of bread    
 
a bar of something  （一块某物）      
 
a pound of something  （一磅某物）           
 
Half a pound of something  （半磅某物）           
 
a quarter of something   （四分之一某物）     
 
a tin of something (一盒某物)     
...
| word       | countable? | remark                                                       | 例句                                                         | 
| ---------- | ---------- | ------------------------------------------------------------ | ------------------------------------------------------------ | 
| hair       | both fine  | 当作为头发整体概念时不可数<br />强调几根头发时可数           | There boys need to have their hair cut(这些男孩需要去剪头发了)<br />There are a few hairs in the book  (书里面有几根头发) | 
| light      | both fine  | 当表述为光的时候，不可数<br />当表述为灯的时候，可数         | I thought there was somebody in the house,because there is a light on inside(light on搭配只能是灯亮，on不是修饰inside的说！要修饰也应该是in) | 
| experience | both fine  | 当表达为知识或者经验时不可数<br />当表达为亲身经历时，可数   | I had some interesting experiences during the journey<br />这里的experience是指作者亲身的经历，所以可数 | 
| cake       | both fine  | 可数：当新鲜出炉，没有被切的时候<br />不可数: 被切成小块的时候 |                                                              | 
| chips      | no         | 跟rice一样，构成单位太小以至于强调它的整体属性，所以不可数   |                                                              | 
...
| a few                              | a litter                                         | a lot of<br />例句：They need a lot of bread                 | 
| few                                | litter                                           | any(在疑问句不区分是单数复数)                                | 
...
| 表目的(为了)     | He was waiting for the bus(他为了公交车在等待=他在等公交车) |        | 
